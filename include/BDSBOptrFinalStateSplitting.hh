...
*/
#ifndef BDSBOPTRFINALSTATESPLITTING_H
#define BDSBOPTRFINALSTATESPLITTING_H
...
class BDSBOptrFinalStateSplitting: public G4VBiasingOperator
{
public:
    BDSBOptrFinalStateSplitting(const G4String& particleToBias,
			     const G4String& name = "ChangeFS");
  virtual ~BDSBOptrFinalStateSplitting();
...
private: 
  ...
  std::map<const G4BiasingProcessInterface*, BDSBOptnFinalStateSplitting*> fChangeFinalStateOperations;
  std::map<const G4BiasingProcessInterface*, G4int>                        fSplittingFactor;
  std::map<const G4BiasingProcessInterface*, G4double>                     fSplittingThreshold;
  G4bool                                                                   fSetup;
  G4String                                                                 particleName;
  const G4ParticleDefinition*                                              fParticleToSplit;
